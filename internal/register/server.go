...
func Step(path string) {
	...
	if err := Client.setLease(10); err != nil {
		fmt.Println(err)
		os.Exit(0)
	}
...
//设置租约
func (e *etcd) setLease(timeNum int64) error {

	//设置租约时间
	leaseResp, err := e.client.Lease.Grant(context.TODO(), timeNum)
	if err != nil {
		return err
	}
...
func (e *etcd) PutNode(name, addr string) error {

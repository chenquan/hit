...
import (
	...
	"github.com/chenquan/hit/remote/remotecache"
...
const (
	defaultBasePath = "/distributed-cache/"
	defaultReplicas = 50
)
...
var _ remote.PeerGetter = (*httpGetter)(nil)
...
func (h *httpGetter) Get(in *remotecache.Request, out *remotecache.Response) error {
	u := fmt.Sprintf(
		"%v%v/%v",
		h.url,
